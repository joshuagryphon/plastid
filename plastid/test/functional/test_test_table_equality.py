...
def test_exit_status():
    ...
    table1.to_csv(noheaderfile , index=False , header=False , sep="\t", columns=keyorder)
    headerfile.close()
    noheaderfile.close()
    ...
    table2.to_csv(noheaderfile_shuffled , index=False , header=False , sep="\t", columns=keyorder)
