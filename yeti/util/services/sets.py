...
------------------
:py:func:`merge_sets`
    Recursive merging of sets based upon common members, until all groups
...
def merge_sets(list_of_sets,verbose=False,printer=None):
    ...
    Parameters
    ----------
    list_of_sets : list<set<hashable>>
...
def _merge_sets(list_of_sets,verbose=False,printer=None,callback=merge_sets):
    """Inner loop function for merge_sets().
    ...
    callback : function
        Callback function for next recursive call
